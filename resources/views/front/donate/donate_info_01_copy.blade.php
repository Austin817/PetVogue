                ...
                <div class="donate-detail-input">
                    ...
                    <div class="input-price">
                        ...
                        <select name="" id="price">
                            <option value="88">88 - 小小支持，大大改變</option>
                            <option value="888">888 - 動保路上，有您真好</option>
                            <option value="8888">8888 - 因為有您，浪愛不斷</option>
                            <option value="81000">81000 - 八萬一公道價啦</option>
                        </select>
                        <p>捐款人姓名</p>
